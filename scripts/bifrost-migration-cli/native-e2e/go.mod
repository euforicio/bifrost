module github.com/maximhq/bifrost/scripts/bifrost-migration-cli/native-e2e
...
require (
	...
	github.com/maximhq/bifrost/scripts/bifrost-migration-cli v0.0.0
)
...
replace github.com/maximhq/bifrost/scripts/bifrost-migration-cli => ..
